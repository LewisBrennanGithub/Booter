...
//        addressRepository.deleteAll();
        ...
        Player clive = new Player("Clive", "Norris", "Norry", "0123456789", dumbiedykesLane6, 22, 2.0, 4.0);
        playerRepository.save(clive);

        Player john = new Player("Barry", "Pheltz", "Pheltzy", "0234567891", georgeStreet8, 28, 3.5, 3.0);
        playerRepository.save(john);

        Player jane = new Player("Mon", "Jinton", "MonJinton", "0345678923", piccadillySquare10, 30, 4.0, 4.5);
        playerRepository.save(jane);

        Player alice = new Player("Colin", "Dent", "Denty", "0456789123", bakerStreet12, 24, 3.0, 3.5);
        ...
        Player hannah = new Player("Lewis", "Brennan", "Brennobot", "0923456789", oxfordStreet26, 26, 0.5, 0.5);
        playerRepository.save(hannah);

        Player isaac = new Player("Euan", "Connelly", "Euan", "0934567890", kingStreet28, 28, 3.5, 3.5);
